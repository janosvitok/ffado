...
#define MAUDIO_PROFIRE2626_REGISTER_APP_CONTROLLER_MODE_OFFSET 0x01
#define MAUDIO_PROFIRE2626_REGISTER_APP_CONTROLLER_MODE_VALUE 1
#define MAUDIO_PROFIRE2626_REGISTER_APP_CONTROLLER_MODE_SHIFT 1
